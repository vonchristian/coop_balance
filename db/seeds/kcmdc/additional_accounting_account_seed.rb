...
AccountingModule::Asset.create(code: 1113024, name: "Cash in Bank(RBBI Lamut)")

AccountingModule::Asset.create(code: 1113025, name: "Other Funds and Deposit (MSCB)")
AccountingModule::Asset.create(code: 1113025, name: "Other Funds and Deposit (Banco Lagawe - Time Deposit)")
AccountingModule::Asset.create(code: 1113025, name: "Other Funds and Deposit (Banco Lagawe - Retirement Fund)")
AccountingModule::Asset.create(code: 1113025, name: "Other Funds and Deposit (Banco Lagawe - Reserve Fund)")
AccountingModule::Asset.create(code: 1113025, name: "Other Funds and Deposit (Banco Lagawe - CETF Fund)")
AccountingModule::Asset.create(code: 1113025, name: "Other Funds and Deposit (Banco Lagawe - CDF Fund)")
AccountingModule::Asset.create(code: 1113025, name: "Other Funds and Deposit (Banco Lagawe - Special Savings)")
AccountingModule::Asset.create(code: 1113025, name: "Other Funds and Deposit (CLIMBS - Optional Fund)")
...
AccountingModule::Asset.create(code: 141101,  name: "Land in Nayon")
...
AccountingModule::Asset.create(code: 179102,  name: "Accumulated Depreciation - Water Tank and Cistern")
...
AccountingModule::Liability.create(code: 227001, name: 'Due to MSCB')
AccountingModule::Liability.create(code: 227001, name: 'Due to NATTCO')
AccountingModule::Liability.create(code: 227001, name: 'Due to IFEDECO')
AccountingModule::Liability.create(code: 227001, name: 'Due to NELCO LEAGUE')
