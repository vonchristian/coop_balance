...
AccountingModule::Asset.create(code: "11721-05", name: "Accounts Receivables (Appliance Financing)")
...
AccountingModule::Asset.create(code: "17900-01",  name: "Temporary Loans Account")
AccountingModule::Asset.create(code: "17900-02",  name: "Temporary Bank Account")
AccountingModule::Asset.create(code: "17900-03",  name: "Temporary Merchandise Inventory Account")
...
AccountingModule::Liability.create(code: "24000-01", name: 'Mortuary Aid Fund')
AccountingModule::Liability.create(code: "24000-02", name: 'Cooperative Guarantee Fund')
AccountingModule::Liability.create(code: "24000-03", name: 'Mutual Assistance System')
...
AccountingModule::Equity.create(code: "30640-01", name: 'Land and Building Fund')
AccountingModule::Equity.create(code: "30640-02", name: 'Loan Redemption Fund')
...
AccountingModule::Revenue.create(code: "40140-01", name: 'Loan Penalties Income')
AccountingModule::Revenue.create(code: "40140-01-01", name: 'Loan Penalties Income - Regular Loan')
AccountingModule::Revenue.create(code: "40140-01-02", name: 'Loan Penalties Income - Emergency Loan')
AccountingModule::Revenue.create(code: "40140-01-03", name: 'Loan Penalties Income - Special Loan')
AccountingModule::Revenue.create(code: "40140-01-04", name: 'Loan Penalties Income - Contractors Loan')
AccountingModule::Revenue.create(code: "40140-01-05", name: 'Loan Penalties Income - Agri Input Loan')
AccountingModule::Revenue.create(code: "40140-01-06", name: 'Loan Penalties Income - Salary Loan')
AccountingModule::Revenue.create(code: "40140-01-07", name: 'Loan Penalties Income - Short-Term Loan')
AccountingModule::Revenue.create(code: "40140-01-08", name: 'Loan Penalties Income - Productive Loan')
AccountingModule::Revenue.create(code: "40140-01-09", name: 'Loan Penalties Income - Appliance Loan')
