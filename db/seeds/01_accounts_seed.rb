...
AccountingModule::Equity.create(code: "30000", name: 'Equity')
	...
	AccountingModule::Equity.create(code: "30640", name: 'Optional Fund')
		AccountingModule::Equity.create(code: "30640-01", name: 'Community Development Fund')
	...
	AccountingModule::Equity.create(code: "30700-01", name: 'Temporary Share Capital Account')
...
AccountingModule::Revenue.create(code: "40100-01", name: 'Income from Lease Agreement - Building Rentals')
...
AccountingModule::Revenue.create(code: "40350", name: 'Interest Rebates', contra: true)
...
AccountingModule::Revenue.create(code: "40450-01", name: 'Accrued Income(Appliance Financing)')
...
AccountingModule::Expense.create(code: "73630-01", name: "Affiliation Fee - NORLU/IFEDECO", main_account_id: AccountingModule::Account.find_by_name('Administrative Cost').id)
AccountingModule::Expense.create(code: "73630-02", name: "Clothing Allowance", main_account_id: AccountingModule::Account.find_by_name('Administrative Cost').id)
AccountingModule::Expense.create(code: "73630-03", name: "Personnel Economic Relief Allowance(PERA)", main_account_id: AccountingModule::Account.find_by_name('Administrative Cost').id)
AccountingModule::Expense.create(code: "73630-04", name: "13th Month Pay", main_account_id: AccountingModule::Account.find_by_name('Administrative Cost').id)
AccountingModule::Expense.create(code: "73630-05", name: "Cash Gift", main_account_id: AccountingModule::Account.find_by_name('Administrative Cost').id)
AccountingModule::Expense.create(code: "73630-06", name: "SSS Employers' Share", main_account_id: AccountingModule::Account.find_by_name('Administrative Cost').id)
AccountingModule::Expense.create(code: "73630-07", name: "PhilHealth Employers' Share", main_account_id: AccountingModule::Account.find_by_name('Administrative Cost').id)
AccountingModule::Expense.create(code: "73630-08", name: "PAGIBIG Fund Employers' Share", main_account_id: AccountingModule::Account.find_by_name('Administrative Cost').id)
AccountingModule::Expense.create(code: "73630-09", name: "Uniform Allowance", main_account_id: AccountingModule::Account.find_by_name('Administrative Cost').id)
AccountingModule::Expense.create(code: "73630-10", name: "Other Personnel Benefits", main_account_id: AccountingModule::Account.find_by_name('Administrative Cost').id)
