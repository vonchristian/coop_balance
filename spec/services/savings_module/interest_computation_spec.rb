...
module SavingsModule
  describe InterestComputation do 
    it "#compute_interest!" do 
      ...
      saving_product_interest_config = create(:saving_product_interest_config, interest_posting: 'annually', annual_rate: 0.03, minimum_balance: 500, saving_product: saving_product)
