  ...
  module PredeductedInterestCalculators
    describe NumberOfPaymentsDecliningBalance do
      it "prededucted_interest" do
        ...
        puts loan_application.amortization_schedules.map{ |schedule| schedule.interest }

        prededucted_interest = (BigDecimal(described_class.new(loan_application: loan_application).prededucted_interest)).to_f
