  ...
  module PredeductedInterestCalculators
    describe PercentBasedStraightLine do
      it "#prededucted_interest" do
        ...
        interest_prededuction = create(:interest_prededuction, loan_product: loan_product, rate: 0.75, calculation_type: 'percent_based', prededuction_scope: 'on_first_year')
        ...
        expect(described_class.new(loan_application: loan_application).prededucted_interest).to eql 9_000.00
      end
    end
  end
end
