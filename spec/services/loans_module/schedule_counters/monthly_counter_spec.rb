  ...
  module ScheduleCounters
    describe MonthlyCounter do
      it '#schedule_count' do
        ...
        expect(described_class.new(loan_application: loan_application_2).schedule_count).to be 2
        expect(described_class.new(loan_application: loan_application_12).schedule_count).to be 12
      end
    end
  end
end
