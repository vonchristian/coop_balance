  ...
  module ScheduleCounters
    describe WeeklyCounter do
      ...
      it 'number of weeks per month' do
        expect(LoansModule::ScheduleCounters::WeeklyCounter::NUMBER_OF_DAYS_PER_WEEK).to eql 7
      end
      ...
      it '#schedule_count' do
        ...
        expect(described_class.new(loan_application: loan_application_weekly_2).schedule_count).to eql 2
        expect(described_class.new(loan_application: loan_application_weekly_4).schedule_count).to eql 4
      end
    end
  end
end
