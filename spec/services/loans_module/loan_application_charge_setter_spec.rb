...
module LoansModule
  describe LoanApplicationChargeSetter do
    ...
    it "#create_charges_based_on_loan_product" do
      ...
      expect(loan_application.voucher_amounts.find_by(description: "Service Fee").amount.amount).to eql 3_000
      expect(loan_application.voucher_amounts.find_by(description: "Filing Fee").amount.amount).to eql 100
    ...
    it "#create_loan_protection_fund" do
      ...
      expect(loan_application.voucher_amounts.find_by(description: "Loan Protection Fund").amount.amount).to eql 1_620
    end
  end
end
