  ...
  describe BalanceTransferVoucher, type: :model do 
    ...
    it "#process!" do 
      ...
      described_class.new(
        ...
        share_capital_id: share_capital_1.id).process!
      ...
      expect(cart.voucher_amounts.credit).to_not include(credit_amount)
      expect(cart.voucher_amounts.debit).to_not include(debit_amount)
