...
module ShareCapitals
  describe BalanceTransferProcessing, type: :model do
    describe 'attributes' do
      it { should respond_to(:origin_share_capital_id) }
      it { should respond_to(:destination_share_capital_id) }
    ...
    describe 'validations' do
      ...
      it { should validate_presence_of :origin_share_capital_id }
      it { should validate_presence_of :destination_share_capital_id }
