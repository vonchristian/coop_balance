...
module AccountingModule
  module BalanceFinders
    describe AmountsCommercialDocumentToDate do
      it '.compute' do
        ...
        expect(described_class.new(amounts: AccountingModule::Amount.all, commercial_document: saving, to_date: Date.current.last_month.end_of_month).compute).to eql 200
        expect(described_class.new(amounts: AccountingModule::Amount.all, commercial_document: saving, to_date: Date.current.end_of_month).compute).to eql 800
