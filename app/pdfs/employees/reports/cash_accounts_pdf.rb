    ...
    class CashAccountsPdf < Prawn::Document
      ...
      def heading
        ...
        bounding_box [ 0, 770 ], width: 400 do
          ...
          table([ [ "As of:", to_date.strftime("%B %e, %Y").to_s ] ],
                cell_style: { padding: [ 0, 0, 1, 0 ], inline_format: true, size: 10 },
                column_widths: [ 50, 150 ]) do
            cells.borders = []
            column(1).font_style = :bold
      ...
      def accounts_table
        ...
        table([ [ "TOTAL", "",
                price(accounts.balance(to_date: to_date.yesterday.end_of_day)).to_s,
                price(accounts.debits_balance(to_date: to_date)).to_s,
                price(accounts.credits_balance(to_date: to_date)).to_s,
                price(accounts.balance(to_date: to_date)).to_s,
