module Vouchers
  class LoanDisbursementVoucher < Voucher
    ...
    def add_amounts_from(loan)
      self.voucher_amounts.create!(amount_type: 'debit', amount: loan.loan_amount, description: 'Loan Amount', account_id: loan.loan_product.loans_receivable_current_account_id, commercial_document: loan)
