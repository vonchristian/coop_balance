class LoanPaymentForm
  ...
  def save_payment
    AccountingDepartment::Entry.create!(entry_type: 'loan_payment', commercial_document: find_loan, description: 'Loans payment', reference_number: reference_number, entry_date: date,
  ...
  def credit_account
    AccountingDepartment::Account.find_by(name: "Loans Receivable - Current")
  end
  def debit_account
