module ShareCapitals
  class BalanceTransfersController < ApplicationController
    ...
    def new
      ...
      @subscriber_share_capitals = @subscriber.share_capitals.where.not(id: @origin_share_capital.id)
      ...
      if params[:search].present?
        ...
        @pagy, @share_capitals = pagy(current_office.share_capitals.where.not(id: @origin_share_capital.id).where.not(id: @subscriber_share_capitals.ids))
      end
    end
  end
end
