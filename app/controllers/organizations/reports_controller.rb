module Organizations
  class ReportsController < ApplicationController
    def index
      ...
      @date = params[:date].present? ? Date.parse(params[:date]) : Time.zone.today.strftime("%B %e, %Y")
      @membership_type = params[:membership_type].presence || Cooperatives::Membership.whitelisted_membership_types.first
