module StoreFrontModule
  module LineItems
    class PurchaseLineItemProcessingsController < ApplicationController
      def create
        @cart = current_cart
      ...
      def line_item_params
        params.require(:store_front_module_line_items_purchase_line_item_processing).permit(:unit_of_measurement_id, :quantity,:unit_cost, :total_cost, :product_id,  :referenced_line_item_id, :cart_id)
      end
    end
  end
end
