  ...
  module Reports
    class SalesClerkSalesReportsController < ApplicationController
      def index
        ...
        @sales_return_orders = @employee.returned_sales_orders.ordered_on(from_date: @from_date, to_date: @to_date)

        respond_to do |format|
          format.html
          format.pdf do
            pdf = StoreFrontModule::Reports::SalesClerk::SalesReportPdf.new(@employee, @sales_orders, @sales_return_orders, @from_date, @to_date, view_context)
