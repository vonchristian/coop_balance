    ...
    class LoanAgingSummariesController < ApplicationController
      ...
      def csv_body
        Enumerator.new do |yielder|
          ...
          yielder << CSV.generate_line(['Borrower', 'Loan Product', 'Date Release', 'Maturity Date', 'Loan Amount', 'Loan Balance'] + @loan_aging_groups.map(&:title) + ['Term', 'Days Past Due', 'Mode of Payment', 'Share Capital', 'Savings Deposit', 'Time Deposit'])
