    ...
    class JournalEntryVouchersController < ApplicationController
      def index
          ...
          if params[:search].present?
            @entries_for_pdf = current_office.entries.without_cash_accounts.not_cancelled.text_search(params[:search])
            ...
            @entries_for_pdf = current_office.entries.without_cash_accounts.entered_on(from_date: @from_date, to_date: @to_date)
