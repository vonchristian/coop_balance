module AccountingModule
  module IocDistributions
    class SavingVouchersController < ApplicationController
      def create
        ...
        if @voucher.valid?
          ...
          redirect_to accounting_module_ioc_distributions_saving_voucher_url(@find_voucher), notice: "Voucher created successfully."
        else
          redirect_to new_accounting_module_ioc_distributions_saving_url, alert: "Error"
        end
      end
      ...
      def destroy
        ...
        @voucher.destroy
        redirect_to new_accounting_module_ioc_distributions_saving_url, notice: "Transaction cancelled successfully."
      end
