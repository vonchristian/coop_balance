module SavingsAccounts
  class TransactionsController < ApplicationController
    ...
    def index
      ...
      @entries = @savings_account.entries.order(entry_date: :desc).includes(:commercial_document, :recorder, :cooperative_service).distinct.paginate(:page => params[:page], :per_page => 20)
