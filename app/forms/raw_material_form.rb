class RawMaterialForm
  ...
  attr_accessor :name, :description, :unit, :unit_cost, :total_cost, :quantity, :delivery_date, :supplier_id, :recorder_id, :has_freight, :freight_in, :discounted, :discount_amount
