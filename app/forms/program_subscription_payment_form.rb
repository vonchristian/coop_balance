class ProgramSubscriptionPaymentForm
  ...
  def save_payment
    find_program_subscription.entries.create!(recorder_id: recorder_id, entry_type: 'deposit',  description: 'Savings deposit', reference_number: reference_number, entry_date: date,
