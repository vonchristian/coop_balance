module Memberships
  class TimeDepositSubscription
    include ActiveModel::Model
    attr_accessor :reference_number, :account_number, :date, :amount,:depositor_id, :depositor_type, :employee_id, :number_of_days, :time_deposit_product_id
